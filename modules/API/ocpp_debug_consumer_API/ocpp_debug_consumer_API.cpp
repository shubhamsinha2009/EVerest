...
#include "ocpp_debug_consumer_API.hpp"
...
void ocpp_debug_consumer_API::init() {
    invoke_init(*p_generic_error);

    topics.setup(info.id, "ocpp_debug_consumer", 1);
}

void ocpp_debug_consumer_API::ready() {
...
auto ocpp_debug_consumer_API::forward_api_var(std::string const& var) {
...
void ocpp_debug_consumer_API::generate_api_var_ocpp_message() {
    r_ocpp_debug->subscribe_ocpp_message(forward_api_var("security_event"));
}

void ocpp_debug_consumer_API::generate_api_var_communication_check() {
...
void ocpp_debug_consumer_API::setup_heartbeat_generator() {
...
void ocpp_debug_consumer_API::subscribe_api_topic(std::string const& var,
...
const ev_API::Topics& ocpp_debug_consumer_API::get_topics() const {
    return topics;
}
